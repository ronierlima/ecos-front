...
<template>
  <div>
    ...
    <div id="nav">
      <div id="nav-content">
        <ul>
           <li><a @click="pngSalvar()">{{usingLang.export_png}}</a></li>
          <li><a @click="svgExportar()">{{usingLang.export_svg}}</a></li>
          <li><a @click="exportarXml()">{{usingLang.export_xml}}</a></li>
          <li><a @click="exportarJson()">{{usingLang.export_json}}</a></li>
